...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(125, 50),  # All numbers are approximate.
                rg.Point(112, 71),
                rg.Point(87, 71),
                rg.Point(75, 50),
                rg.Point(87, 28),
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  10 pink dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_pizza():
    ...
    # Test 4
    title = 'PIZZA test 4:  30 slices, thin (thickness=2) black lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.outline_thickness = 2
    pizza(window, circle, 30, 'black', 3)
    window.close_on_mouse_click()
